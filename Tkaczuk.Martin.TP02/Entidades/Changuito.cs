    ...
    public class Changuito
    {
        ...
        public static string Mostrar(Changuito c, ETipo tipo)
        {
            ...
            foreach (Producto v in c._productos)
            {
                ...
                {
                    case ETipo.Snacks:
                        Changuito.MostrarProducto(v, ref sb, tipo);
                        break;
                    case ETipo.Dulce:
                        Changuito.MostrarProducto(v, ref sb, tipo);
                        break;
        ...
        public static Changuito operator -(Changuito c, Producto p)
        {
            foreach (Producto v in c._productos)
            {
                if (v == p)
                {
                    c._productos.Remove(p);//remueve el producto
                    break;
                }
            }
            return c;
        ...
        private static void MostrarProducto(Producto v, ref StringBuilder sb, ETipo tipo)
        {
            if (v is Snacks && tipo == ETipo.Snacks)
                sb.AppendLine(((Snacks)v).Mostrar());
            else if (v is Dulce && tipo == ETipo.Dulce)
